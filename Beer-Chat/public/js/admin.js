...
var adminVM = {
  ...
  getProfileView: function getProfileView(user) {
    ...
    profile.addEventListener("click", function () {
      apiManager.getUserById(user.id).then(function (value) {
        adminVM.openUserPanel(value.data);
      })["catch"](function (e) {
        console.log(e);
      });
      apiManager.getAllChats(user.id).then(function (value) {
